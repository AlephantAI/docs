...
|-|-|-|
| [Alephant AI](https://alephant.io/) | [`ChatAlephantAI`](/oss/python/integrations/chat/alephantai) | AI gateway for cost control, bring-your-own-key routing, and access to models across multiple providers |
...
<Card
    title="Alephant AI"
    icon="link"
    href="/oss/python/integrations/chat/alephantai"
    arrow="true"
    cta="View guide"
/>
